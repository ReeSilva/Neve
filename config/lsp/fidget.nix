      ...
      settings = {
        ...
        progress = {
          ...
          display = {
            ...
            progress_ttl = lib.nixvim.utils.mkRaw "math.huge"; # How long a message should persist when in progress
            progress_icon = {
              pattern = "dots";
              period = 1;
            ...
            format_message = lib.nixvim.utils.mkRaw ''
              require ("fidget.progress.display").default_format_message
            ''; # How to format a progress message
            format_annote = lib.nixvim.utils.mkRaw ''
              function (msg) return msg.title end
            ''; # How to format a progress annotation
            format_group_name = lib.nixvim.utils.mkRaw ''
        ...
        notification = {
          ...
          '';
          configs = {
            default = lib.nixvim.utils.mkRaw "require('fidget.notification').default_config";
          };
